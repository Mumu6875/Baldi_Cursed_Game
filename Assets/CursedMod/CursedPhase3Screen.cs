...
public sealed class CursedPhase3Screen : MonoBehaviour
{
    ...
    private void BuildScreen()
    {
        ...
        MakeTouchButton("Clear Password Top", new Vector2(0.229f, 0.466f), new Vector2(0.281f, 0.548f), ClearPassword);
        MakeTouchButton("Clear Password Middle", new Vector2(0.229f, 0.378f), new Vector2(0.281f, 0.461f), ClearPassword);
        MakeTouchButton("Clear Password Bottom", new Vector2(0.229f, 0.291f), new Vector2(0.281f, 0.374f), ClearPassword);
        ...
        MakeTouchButton("Backspace", new Vector2(0.729f, 0.226f), new Vector2(0.767f, 0.296f), Backspace);
        MakeTouchButton("Submit Password", new Vector2(0.644f, 0.015f), new Vector2(0.769f, 0.190f), SubmitPassword);
    }
    ...
    private void CreateDigitButton(int digit, Vector2 anchorMin, Vector2 anchorMax)
    {
        ...
        MakeTouchButton("Digit " + digit, anchorMin, anchorMax, delegate { AddDigit(capturedDigit); });
    }

    private void MakeTouchButton(string objectName, Vector2 anchorMin, Vector2 anchorMax, UnityAction action)
    {
