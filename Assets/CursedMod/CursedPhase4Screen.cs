...
/// <summary>
/// Phase 4 is a single final screen. Tapping anywhere closes the application.
/// </summary>
public sealed class CursedPhase4Screen : MonoBehaviour
{
    ...
    private void BuildScreen()
    {
        ...
        GameObject screenObject = new GameObject("Phase 4 Tap To Close", typeof(RectTransform), typeof(CanvasRenderer), typeof(RawImage), typeof(Button));
