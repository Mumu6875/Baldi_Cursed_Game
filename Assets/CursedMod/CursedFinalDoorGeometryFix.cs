...
public class CursedFinalDoorGeometryFix : MonoBehaviour
{
        ...
        Transform cafeteria)
    {
        ...
        // The chosen existing door already lives in a genuine hole in the
        // Schoolhouse wall. Hide only that door object; the wall and its real
        // opening stay untouched.
        DisableExistingDoorObject(realDoorway.gameObject);

        // Move every generated narrow-room piece from the old fake-wall frame
        // into the real cafeteria doorway frame.
        ...
        // Put the normal Room 99 DoorScript clone into the genuine doorway.
        ...
        // The old passage existed only because we were trying to walk through a
        // solid wall. A real doorway needs no collision bypass at all.
        if (passage != null)
        {
        ...
        // This black plane was never a real hole and is exactly why a wall could
        // still be visible behind an opened door. It is not needed at a genuine
        // doorway.
        ...
        ref float bestScore)
    {
        ...
        // Reject doors that are clearly on another floor / far above or below
        // the cafeteria's vertical range.
        ...
        // Prefer a doorway genuinely on the cafeteria boundary, then prefer
        // room space with fewer objects, then the doorway nearest the intended
        // final-door location.
        float score =
        ...
        GameObject finalDoor)
    {
        ...
        for (int i = 0; i < overlaps.Length; i++)
        {
            ...
            // Small props should not outweigh a structurally cleaner doorway.
...
// Kept only so older scene/runtime references remain loadable. The real-doorway
// relocation disables this component; no wall collision bypass is needed anymore.
